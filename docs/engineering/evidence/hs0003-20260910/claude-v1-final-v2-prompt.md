# HS-00.03 보강 후 최종 후보 Claude V1 독립 적대검증 요청
...
이 후보는 첫 Claude V1이 PASS한 뒤 새 Codex V2가 경계·입력 반례를 찾아 FAIL했고, 이를 두 번째 RED에 고정해 보강했습니다. 보강 후보를 본 실제 Claude V1은 PASS하면서 공백-only 입력 허용과 같은 줄 첫 정상 토큰 뒤 탐색의 시험 공백을 낮은 위험으로 찾았습니다. 공백 동작과 회귀 시험은 세 번째 RED `e99b4549ddf617d0d79acdd63880438cfbf9a7c8`에 먼저 고정한 뒤 현재 후보에서 보강했습니다. 모든 과거 판정은 현재 후보의 합격 근거로 재사용하지 마십시오.
...
> **되돌리기** — 구현 후보만 제거하고 세 RED 시험 커밋을 유지하면 요구 동작이 다시 실패하는지 확인할 수 있습니다.

## 기술 상세와 검증 요청

- 작업트리: `/Users/kangsangmo/Desktop/Valuehire_v6/worktrees/hs-0003-20260910`
- 현재 HEAD와 세 번째 RED: `e99b4549ddf617d0d79acdd63880438cfbf9a7c8`
- 두 번째 RED: `d1058cadb764056c4f52696ea0321038c660a12c`
...
- manifest SHA-256: `c466946aad003159a07c052979e8e0034ec4eeb0d3445d5a9ccb7952a6b7e6d4`
- bundle SHA-256: `9517376e3755a69e4e9dfca8ac5ad859654cbb94dda8cd3b610075c61b40e23d`
...
- 최종 Codeaudit: `docs/engineering/evidence/hs0003-20260910/codeaudit-final-v2-verdict.md`
- 적대 검증: `docs/engineering/evidence/hs0003-20260910/adversarial-final-verification.md`

목표 입력 칸은 파싱된 workflow 스텝 이름, 정본의 스텝 이름 칸, 처분 대상 칸입니다. 원문은 보존하고 비교 사본은 거부 판정에만 사용해야 합니다. `PR #13１`, `ｘPR #13`, `ｘhs-kickoff (`를 실제 shell 경로에서 거부해야 합니다. 빈 입력, 빈 문자열 한 줄, 공백뿐인 이름 한 줄, 해독할 수 없는 UTF-8은 종료값 2여야 합니다. 같은 줄에서 정상 보호 토큰을 먼저 본 뒤에도 뒤쪽 위장 토큰을 계속 찾아야 합니다.
...
4. 0바이트, 빈 문자열 한 줄, 공백뿐인 이름 한 줄, 잘못된 UTF-8이 종료값 2인지 확인합니다.
5. helper 결과를 shell이 무시하거나 경계 치환 검사를 제거하는 고장 사본과 첫 정상 토큰에서 탐색을 멈추는 고장 사본이 시험에 잡히는지 임시 사본에서 확인합니다.
...
적대 검증: baseline 1, mutants killed 11/11, product workspace untouched
...
expected manifest sha256: c466946aad003159a07c052979e8e0034ec4eeb0d3445d5a9ccb7952a6b7e6d4
expected bundle sha256: 9517376e3755a69e4e9dfca8ac5ad859654cbb94dda8cd3b610075c61b40e23d
```
