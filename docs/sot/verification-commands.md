...
| 25 | 인수 검사 hs-1300 | `bash scripts/verify/run-acceptance.sh scripts/acceptance-hs-1300.sh` + `bash scripts/verify/run-acceptance.sh scripts/acceptance-hs-1300-mutations.sh` — HumanSearch HS-13.00 브리프 스펙 구조·의미(catch-all·결정 D1~D12 내용·WU 카드 20 의 5셀·참조 파일 이 트리 실존·명령 형식·타입 12 펜스 안·id↔명령 결합·D9 문구, `CHECKED: 90`) + 자기 변이 33종(`CHECKED: 34`) |
